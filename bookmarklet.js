(function(){
	if(!window.__profiler||window.__profiler.scriptLoaded!==true){
		...
		l.style.cssText='z-index:999;position:fixed;top:10px;left:10px;display:inline;width:auto;font-size:14px;line-height:1.5em;font-family:Arial,Helvetica,Calibri,sans-serif;text-shadow:none;padding:3px 10px 0;background:#fffdf2;box-shadow:0 0 0 3px rgba(0,0,0,.25),0 0 5px 5px rgba(0,0,0,.25); border-radius:1px';
		l.innerHTML='Just a moment';
		s.src='//scunliffe.github.io/timing/profiler.js';
		s.onload=c;
